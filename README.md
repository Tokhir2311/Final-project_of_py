...
2. View All Accounts Tizimda mavjud barcha akkauntlarni list qilib chiqaradi. Bunda BankAccount objectining display_info() yoki __str__() methodidan foydalaning.

3. Search Account List ichidan kiritilgani bo’yicha account qidirish. Bunda user account nomi bo’yicha qidirishi mumkin.

4. Deposit Accountga pul kirimi. balance atributini to’g’ridan-to’g’ri emas, maxsus method bilan (masalan deposit()) o’zgartirasiz. Amalga oshirilgan transaksiyalar transactions listiga saqlab boriladi. Har bir transaksiya alohida dictionary sifatida saqlanishi kerak, bunda uning tuzilishi:
...
5. Withdraw Accountdan pul chiqimi. Bunda ham balance attributini shu method yordamida kamaytirasiz (belgilangan miqdorda). Amalga oshirilgan transaksiya transactions listiga dictionary ko’rinishida saqlanadi.

6. View Transactions Mazkur akkauntda amalga oshirilgan transaksiyalar listini ko’rish. Bunda transactions listi (atribut) bo’ylab iterate qilinadi va har bir transaction dictionarysi ichidagi ma’lumot ekranga chiqariladi.

7. Delete Account Accountni o’chirish imkoniyati. Agar user akkauntini o’chirishga qaror qilsa, shu user account raqami bilan bir xil fayl ochiladi va barcha tranzaksiyalari faylga saqlab qo’yiladi.
